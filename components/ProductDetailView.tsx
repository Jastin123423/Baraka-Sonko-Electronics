  ...
  return (
    <div className="fixed inset-0 bg-white z-[100] flex flex-col animate-fadeIn overflow-hidden">
      ...
      <div className="flex-shrink-0 bg-white/95 backdrop-blur-md flex items-center justify-between px-4 py-3 border-b border-gray-100 shadow-sm">
        ...
        <div className="text-xs font-black text-gray-800 truncate px-4">Baraka Sonko Electronics</div>
        ...
        <div className="p-4">
          ...
          <div className="py-2">
            ...
            <div className="text-sm text-gray-600 leading-relaxed font-medium">
              <p>Welcome to Baraka Sonko Electronics. Our {product.title} is selected for its superior quality and durability. Perfect for professional or home use.</p>
            </div>
          </div>
